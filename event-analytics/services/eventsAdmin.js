...
function callback(error, response, body) {
    ...
    for(counter=0; counter<entries.length; counter++)   {
        var event_admin_row = [{event_id: entries[counter].event_id, created_at: BigQuery.datetime(entries[counter].created_at), event_type: entries[counter].event_type, ip_address: entries[counter].ip_address, session_id: entries[counter].session_id}];
